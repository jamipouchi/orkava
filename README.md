...
Plaza Catalunya 10, 17004 Girona (España) · help@orkava.app
...
- `styles.css`, `orky.svg` (Orky mascot, copied from the main app), `robots.txt`
...
- Contact email is `help@orkava.app` — make sure the mailbox exists (it is the
